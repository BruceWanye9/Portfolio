       ...
       <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center w-full h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                <h2 className='text-4xl sm:text-7xl font-bold text-white'>
                    Android App Alchemist | 
                </h2>
                <p className='text-[#D5D5CD] py-4 max-w-lg font-bold'>
                    I am Passionate Android Developer. Revolutionizing Android Development: A Showcase of Innovation and Expertise
                </p>
